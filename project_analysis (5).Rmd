...
data_proj %>% 
  dplyr::select(Gender, Age, Primary_line, Rating, Duration_p.line, Satistifaction_p.line, 
                ...
                signal_strength_problems, promotion_considered, rate_service
                ) -> data1
...
**Highest number of respondents with respect to Gender**
...
**a) Distribution of Gender, age category against primary line**

```{r, warning=FALSE, message=FALSE}
# Categorize age the cost of the primary line
data$age_grp <- cut(data$Age, breaks = c(15, 30, 45, 60, 75, 90))
data$cost <- cut(data$cost_line, breaks = c(0, 50, 100, 150, 200, 250, 300, 350, 400, 
                                            450, 500, 550, 600))
...
**b) Frequency distribution for primary line against monthly income and monthly expenditure**
...
**c) Frequency distribution table of primary line against age category and promotional strategies**
...
**d) Service clarity rating with respect to gender and Primary line**
...
**e. Distribution of primary line in relation to job status and monthly expenditure**
